    ...
    <AnimatePresence>
      {sidebar || width > 1024 ? (
        <motion.aside
          ...
          className={`fixed inset-0 top-16 right-auto z-20 flex w-[19.5rem] flex-col overflow-y-auto border-r border-slate-300 bg-white/60 px-8 pb-10 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/60 dark:text-white`}
        >
          <nav
            id="nav"
